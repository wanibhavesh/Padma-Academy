...
<div class="col-md-8">
    <div class="card" style="margin-top: 20px;margin-bottom:15px;">
      <div class="card-body">
        ...
        <a href="https://www.padmaacademy.com/readieltswriting/cambridge-15-test-1-writing" class="btn btn-danger" style="margin: 5px;" >Read</a>
      </div>
    </div>
    ...
    <div class="card" style="margin-bottom:15px;">
      <div class="card-body">
        ...
        <a href="https://www.padmaacademy.com/readieltswriting/cambridge-15-test-2-writing" class="btn btn-danger" style="margin: 5px;" >Read</a>
      </div>
    </div>
    ...
    <div class="card" style="margin-bottom:15px;">
      <div class="card-body">
        ...
        <a href="https://www.padmaacademy.com/readieltswriting/cambridge-15-test-3-writing" class="btn btn-danger" style="margin: 5px;" >Read</a>
      </div>
    </div>
    ...
    <div class="card" style="margin-bottom:15px;">
      <div class="card-body">
        ...
        <a href="https://www.padmaacademy.com/readieltswriting/cambridge-15-test-4-writing" class="btn btn-danger" style="margin: 5px;" >Read</a>
      </div>
    </div>
    ...
    <div class="card" style="margin-bottom:15px;">
      <div class="card-body">
        ...
        <a href="https://www.padmaacademy.com/readieltswriting/cambridge-14-test-1-writing" class="btn btn-danger" style="margin: 5px;" >Read</a>
      </div>
    </div>
    ...
    <div class="card" style="margin-bottom:15px;">
      <div class="card-body">
        ...
        <a href="https://www.padmaacademy.com/readieltswriting/cambridge-14-test-2-writing" class="btn btn-danger" style="margin: 5px;" >Read</a>
      </div>
    </div>
    ...
    <div class="card" style="margin-bottom:15px;">
      <div class="card-body">
        ...
        <a href="https://www.padmaacademy.com/readieltswriting/cambridge-14-test-3-writing" class="btn btn-danger" style="margin: 5px;" >Read</a>
      </div>
    </div>
    ...
    <div class="card" style="margin-bottom:15px;">
      <div class="card-body">
        ...
        <a href="https://www.padmaacademy.com/readieltswriting/cambridge-14-test-4-writing" class="btn btn-danger" style="margin: 5px;" >Read</a>
      </div>
    </div>
