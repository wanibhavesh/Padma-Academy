                                ...
                                <div class="basic-form">
                                    <form method="post" action="{{route('category.store')}}">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="name" class="form-control input-default" placeholder="Category Name" style="text-transform: uppercase;" required>
                                            
                                        </div>
                                        <div class="form-group">
                                            <input type="text" name="code" class="form-control input-default" placeholder="Code" required>
                                    ...
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <form id="delete-form-{{ $row['category_id']}}" method="post" action="{{ route('category.destroy',$row['category_id'])}}" style="display:none">
                                                    {{csrf_field()}}
                                                    {{method_field('DELETE')}}
                                                </form>
                                                <a href="" onclick="
                                                if(confirm('Are you sure you want to delete?'))
                                                {
                                                    ...
                                                    document.getElementById('delete-form-{{$row['category_id']}}').submit();
                                                }
                                                else{
                                                event.preventDefault();
