                                        ...
                                        <tbody>
                                           @foreach($table as $rows)
                                            ...
                                            <tr>
                                                <td>{{ $rows['id']}}</td>
                                                <td>{{ $rows['topic']}}</td>
                                                <td>{{ $rows['topic_slug']}}</td>
                                                <td>{{ $rows['topic_number']}}</td>
                                                <td>{{ $rows['title']}}</td>
                                                <td>{{ $rows['keyword']}}</td>
                                                <td>{{ $rows['image']}}</td>
                                                 <td><a href="{{url('admin/studyabroadeditcontent',$rows['id'])}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
                                                <td>
                                                <form id="delete-form-{{ $rows['id']}}" method="post" action="{{ route('studyabroadcontent.destroy',$rows['id'])}}" style="display:none">
                                                    {{csrf_field()}}
                                                    {{method_field('DELETE')}}
                                                </form>
                                                <a href="" onclick="
