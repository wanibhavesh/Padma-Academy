                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <form method="post" action="{{route('postbandessay')}}">
                                        {{csrf_field()}}
                                        
                                        <input type="text" name="id" class="form-control input-default" value="{{$ielts->id}}" hidden>
                                        <div class="form-group">
                                            <input type="text" name="band" class="form-control input-default" placeholder="Band" required>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card p-4 justify-content-center">
                            ...
                            {!! htmlspecialchars_decode($ielts->ans1) !!}
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card p-4 justify-content-center">
                            ...
                            {!! htmlspecialchars_decode($ielts->ans2) !!}
