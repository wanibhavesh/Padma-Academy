            ...
            <div class="container-fluid mt-3">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Essay Class Table</h4>
                                    ...
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
                                           @foreach($essay as $rows)
                                            ...
                                            @endif
                                                <td>
                                                    <a href="{{url('admin/essayevaluate',$rows['id'])}}" onclick=""><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                                </td>
                                                <td>
                                                <form id="delete-form-{{ $rows['id']}}" method="post" action="{{ route('userans.destroy',$rows['id'])}}" style="display:none">
                                                    {{csrf_field()}}
                                                    {{method_field('DELETE')}}
                                                </form>
                                                <a href="" onclick="
