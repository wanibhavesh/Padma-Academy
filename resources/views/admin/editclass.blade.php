                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <form method="post" action="{{route('updateclass.store',$row['class_id'])}}">
                                        {{csrf_field()}}
                                       
                                        
                                        
                                        <div class="form-group">
                                            <input type="text" name="name" class="form-control input-default" value="{{$row['class_name']}}" placeholder="Class Name" style="text-transform: uppercase;" required>
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="hover" class="form-control input-default" value="{{$row['hover']}}" placeholder="Enter class hover" required>
