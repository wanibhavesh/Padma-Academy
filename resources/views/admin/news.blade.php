        ...
        <div class="content-body">
            ...
            <div class="container-fluid mt-3">
                <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Marquee News</h4>
                                
                                <div class="basic-form">
                                    <form method="post" action="{{route('news.update',$row['id'])}}">
                                        {{csrf_field()}}
                                        {{method_field('PATCH')}}
                                        <div class="form-group">
                                            <input type="text" name="news" class="form-control input-default" value="{{$row['news']}}" required>
                                        </div>
                                        <div class="form-group">
