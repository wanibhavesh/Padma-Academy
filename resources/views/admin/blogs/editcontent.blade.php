                                           ...
                                           @foreach($blogs as $rows)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $rows['category_slug']}}</td>
                                                 ...
                                                 <td><a href="{{url('admin/editblog',$rows['id'])}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
                                                <td>
                                                <form id="delete-form-{{ $rows['id']}}" method="post" action="{{ route('blogs.destroy',$rows['id'])}}" style="display:none">
                                                    {{csrf_field()}}
                                                    {{method_field('DELETE')}}
                                                </form>
                                                <a href="" onclick="
