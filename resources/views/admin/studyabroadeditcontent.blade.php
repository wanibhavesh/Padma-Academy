                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <form action="{{route('studyabroadupdatecontent',$cont->id)}}" method="post">
                                        {{csrf_field()}}
                                       
                                
                                        <div class="form-group">
                                            <label>Topic Name</label>
                                            <input type="text" name="topicname" class="form-control input-default" placeholder="Subtopic" value="{{$cont->topic}}" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="number" min="1" class="form-control input-default" placeholder="Subtopic Number" value="{{$cont->topic_number}}" required>
                                        </div>
                                       
                                       <div class="form-group">
                                           <label>Title Tags Minimum 10+ words</label>
                                            <input type="text" name="title" placeholder="title" class="form-control input-default" value="{{$cont->title}}" required >
                                            
                                        </div>
                                        <div class="form-group">
                                            <label>Keyword Tags long keywords of 8-10 words</label>
                                            <input type="text" name="keyword" placeholder="keyword" class="form-control input-default" value="{{$cont->keyword}}" required >
                                            
                                        </div>
                                        <div class="form-group">
                                            <label>Description Tags Minimum 150+ words</label>
                                            <input type="text" name="description" placeholder="description" class="form-control input-default" value="{{$cont->description}}" required >
                                            
                                        </div>
                                       
                                       <div class="form-group">
                                            <label>Image Path</label>
                                            <input type="text" name="image" placeholder="image" class="form-control input-default" value="{{$cont->image}}" required >
                                            
                                        </div>
                                        <div class="form-group">
                                            <textarea name="editor1" id="editor" required>{{$cont->content}} </textarea>
                                            <script>
