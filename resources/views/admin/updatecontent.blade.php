                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <form method="post" action="{{route('updatecontent',$cont->id)}}">
                                        {{csrf_field()}}
                                    ...
                                    <input type="text" name='clas' value="{{ $pass }}" hidden>
                                        ...
                                        <div class="form-group">
                                            <select class="form-control" name="chapter" required>
                                                ...
                                                <option>{{$cont->chapter_slug}}</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control input-default" placeholder="Subtopic" value="{{$cont->subtopic}}" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="number" min="1" class="form-control input-default" placeholder="Subtopic Number" value="{{$cont->subtopic_number}}" required>
                                        </div>
                                       
                                       <div class="form-group">
                                            <label>Title Tags Minimum 10+ words</label>
                                            <input type="text" name="title" class="form-control input-default"  value="{{$cont->title}}">
                                            
                                        </div>
                                        <div class="form-group">
                                            <label>Keyword Tags long keywords of 8-10 words</label>
                                            <input type="text" name="keyword" class="form-control input-default"  value="{{$cont->keyword}}">
                                            
                                        </div>
                                        <div class="form-group">
                                            <label>Description Tags Minimum 150+ words</label>
                                            <input type="text" name="description" class="form-control input-default"  value="{{$cont->description}}">
